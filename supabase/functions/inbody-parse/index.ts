...
import { createParseInBodyHandler } from '../_bundles/inbody-parse-handler.js';

let handler: ReturnType<typeof createParseInBodyHandler> | null = null;

const getHandler = () => {
  if (!handler) {
    handler = createParseInBodyHandler();
  }
  return handler;
};
