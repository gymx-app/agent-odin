...
import { createConfirmSwapHandler } from '../_bundles/confirm-swap-handler.js';

let handler: ReturnType<typeof createConfirmSwapHandler> | null = null;

const getHandler = () => {
  if (!handler) {
    handler = createConfirmSwapHandler();
  }
  return handler;
};
