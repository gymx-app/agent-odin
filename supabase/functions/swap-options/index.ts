...
import { createSwapOptionsHandler } from '../_bundles/swap-options-handler.js';

let handler: ReturnType<typeof createSwapOptionsHandler> | null = null;

const getHandler = () => {
  if (!handler) {
    handler = createSwapOptionsHandler();
  }
  return handler;
};
