...
import { createNextPrescriptionHandler } from '../_bundles/next-prescription-handler.js';

let handler: ReturnType<typeof createNextPrescriptionHandler> | null = null;

const getHandler = () => {
  if (!handler) {
    handler = createNextPrescriptionHandler();
  }
  return handler;
};
