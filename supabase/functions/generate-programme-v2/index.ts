...
import { createGenerateProgrammeV2Handler } from '../_bundles/generate-programme-v2-handler.js';

let handler: ReturnType<typeof createGenerateProgrammeV2Handler> | null = null;

const getHandler = () => {
  if (!handler) {
    handler = createGenerateProgrammeV2Handler();
  }
  return handler;
};
