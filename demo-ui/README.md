...
Standalone React + Vite + TypeScript interface for exercising Odin's existing
public API. It does not add or alter backend contracts.
...
Supabase manage the browser session, and sends the resulting access token to
Odin. Never put the Supabase service-role key in this project.
